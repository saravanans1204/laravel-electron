    ...
    <div class="content container-fluid">
        ...
        <div class="page-header">
            <div class="row align-items-center mb-3">
                <div class="col-sm">
                    <h1 class="page-header-title">{{ translate('messages.customers') }}
                                ...
                                <div id="showHideDropdown"
                                    ...
                                    <div class="card card-sm">
                                        <div class="card-body">
                                            ...
                                            <div class="d-flex justify-content-between align-items-center mb-3">
                                                <span class="mr-2">{{ translate('messages.email') }}</span>
                ...
                <table id="datatable"
                    ...
                    <thead class="thead-light">
                        <tr>
                            ...
                            <th>{{ translate('messages.active') }}/{{ translate('messages.inactive') }}</th>
                                ...
                                <td>
                                    <a class="btn btn-sm btn-white"
                                        ...
                                        title="{{ translate('messages.view') }} {{ translate('messages.customer') }}"><i
                                            class="tio-visible text-primary"></i>
                                    </a>
                                </td>
                            </tr>
                        @endforeach
