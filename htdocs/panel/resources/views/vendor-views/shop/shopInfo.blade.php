            ...
            <div class="card-body">
                ...
                <div class="row mt-2">
                    ...
                    <div class="col-md-8 mt-4">
                        ...
                        <span class="h5">{{translate('messages.admin_commission')}} : {{(isset($shop->comission)?$shop->comission:\App\Models\BusinessSetting::where('key','admin_commission')->first()->value)}}%</span><br>
                        <span class="h5">{{translate('messages.vat/tax')}} : {{$shop->tax}}%</span><br>
