        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header">
                    <h1 class="h3 mb-0 text-capitalize">{{translate('messages.edit')}} {{translate('messages.store')}} {{translate('messages.info')}}</h1>
                </div>
                <div class="card-body">
                    <form action="{{route('vendor.shop.update')}}" method="post"
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label for="name">{{translate('messages.upload')}} {{translate('messages.logo')}}</label>
