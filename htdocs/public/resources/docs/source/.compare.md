...
curl -X POST \
    ...
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}" \
    -d '{"user_id":1,"clock_in_time":"2000-06-13 13:13:00","clock_in_note":"itaque","ip_address":"tenetur","latitude":"adipisci","longitude":"eos"}'
...
curl -X POST \
    ...
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}" \
    -d '{"user_id":1,"clock_out_time":"2000-06-13 13:13:00","clock_out_note":"cupiditate","latitude":"optio","longitude":"cupiditate"}'
...
```bash
curl -X GET \
    -G "https://geekbills.in/public/connector/api/holidays?location_id=dolorum&start_date=2020-06-25&end_date=2020-06-25" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```bash
curl -X GET \
    -G "https://geekbills.in/public/connector/api/crm/follow-ups?start_date=2020-12-16&end_date=2020-12-16&status=animi&follow_up_type=voluptatem&order_by=start_datetime&direction=desc&per_page=10" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```bash
curl -X GET \
    -G "https://geekbills.in/public/connector/api/crm/leads?assigned_to=1%2C2%2C3&name=et&biz_name=et&mobile_num=2&contact_id=ad&order_by=ut&direction=desc&per_page=10" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
curl -X POST \
    ...
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}" \
    -d '{"call_logs":[{"mobile_number":"doloremque","mobile_name":"possimus","call_type":"call","start_time":"sunt","end_time":"et","duration":"expedita"}]}'
...
```bash
curl -X GET \
    -G "https://geekbills.in/public/connector/api/cash-register?status=open&user_id=10&start_date=2018-06-25&end_date=2018-06-25&location_id=nam&per_page=15" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
curl -X POST \
    ...
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}" \
    -d '{"location_id":20,"initial_amount":5.013899,"created_at":"2020-5-7 15:20:22","closed_at":"2020-5-7 15:20:22","status":"close","closing_amount":644.0438,"total_card_slips":1,"total_cheques":5,"closing_note":"vitae","transaction_ids":"1,2,3"}'
...
```bash
curl -X GET \
    -G "https://geekbills.in/public/connector/api/contactapi?type=similique&name=rem&biz_name=culpa&mobile_num=6&contact_id=ducimus&order_by=quia&direction=qui&per_page=10" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
curl -X POST \
    ...
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}" \
    -d '{"type":"customer","supplier_business_name":"sunt","prefix":"suscipit","first_name":"dolores","middle_name":"reprehenderit","last_name":"et","tax_number":"8787fefef","pay_term_number":3,"pay_term_type":"months","mobile":"4578691009","landline":"5487-8454-4145","alternate_number":"841847541222","address_line_1":"at","address_line_2":"quas","city":"vel","state":"sunt","country":"quas","zip_code":"harum","customer_group_id":"laudantium","contact_id":"nisi","dob":"2000-06-13","custom_field1":"reprehenderit","custom_field2":"recusandae","custom_field3":"laboriosam","custom_field4":"sapiente","email":"nesciunt","shipping_address":"illo","position":"ex","opening_balance":0,"source_id":17,"life_stage_id":10,"assigned_to":[]}'
...
let body = {
    "type": "customer",
    "supplier_business_name": "sunt",
    "prefix": "suscipit",
    "first_name": "dolores",
    "middle_name": "reprehenderit",
    "last_name": "et",
    ...
    "country": "quas",
    "zip_code": "harum",
    "customer_group_id": "laudantium",
    "contact_id": "nisi",
    "dob": "2000-06-13",
    "custom_field1": "reprehenderit",
    "custom_field2": "recusandae",
    "custom_field3": "laboriosam",
    "custom_field4": "sapiente",
    "email": "nesciunt",
    "shipping_address": "illo",
    "position": "ex",
    "opening_balance": 0,
    "source_id": 17,
    "life_stage_id": 10,
...
curl -X PUT \
    ...
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}" \
    -d '{"type":"customer","supplier_business_name":"et","prefix":"harum","first_name":"excepturi","middle_name":"est","last_name":"eius","tax_number":"488744dwd","pay_term_number":3,"pay_term_type":"months","mobile":"8795461009","landline":"65484-848-848","alternate_number":"9898795220","address_line_1":"dicta","address_line_2":"ut","city":"laudantium","state":"odio","country":"earum","zip_code":"laborum","customer_group_id":"expedita","contact_id":"dignissimos","dob":"2000-06-13","custom_field1":"animi","custom_field2":"natus","custom_field3":"perferendis","custom_field4":"eos","email":"qui","shipping_address":"qui","position":"sed","opening_balance":10.3,"source_id":7,"life_stage_id":4,"assigned_to":[]}'
...
let body = {
    ...
    "contact_id": "dignissimos",
    "dob": "2000-06-13",
    "custom_field1": "animi",
    "custom_field2": "natus",
    "custom_field3": "perferendis",
    "custom_field4": "eos",
    "email": "qui",
...
curl -X POST \
    ...
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}" \
    -d '{"contact_id":17,"amount":453.13,"method":"cash","paid_on":"2020-07-22 15:48:29","account_id":4,"card_number":"accusamus","card_holder_name":"minima","card_transaction_number":"praesentium","card_type":"sit","card_month":"consequatur","card_year":"rerum","card_security":"illum","transaction_no_1":"et","transaction_no_2":"soluta","transaction_no_3":"illum","cheque_number":"aspernatur","bank_account_number":"ut","note":"magni"}'
...
let body = {
    ...
    "account_id": 4,
    "card_number": "accusamus",
    "card_holder_name": "minima",
    "card_transaction_number": "praesentium",
    "card_type": "sit",
    "card_month": "consequatur",
    "card_year": "rerum",
    "card_security": "illum",
    "transaction_no_1": "et",
    "transaction_no_2": "soluta",
    "transaction_no_3": "illum",
    "cheque_number": "aspernatur",
...
```bash
curl -X GET \
    -G "https://geekbills.in/public/connector/api/expense?location_id=dicta&payment_status=paid&start_date=2018-06-25&end_date=2018-06-25&expense_for=consectetur&per_page=15" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
curl -X POST \
    ...
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}" \
    -d '{"location_id":6,"final_total":8578303,"transaction_date":"2020-5-7 15:20:22","tax_rate_id":13,"expense_for":10,"contact_id":1,"additional_notes":"sit","is_refund":0,"is_recurring":0,"recur_interval":3,"recur_interval_type":"months","subscription_repeat_on":15,"subscription_no":"culpa","recur_repetitions":17,"payment":[{"amount":453.13,"method":"cash","account_id":19,"card_number":"provident","card_holder_name":"rem","card_transaction_number":"rerum","card_type":"sit","card_month":"nihil","card_year":"ratione","card_security":"modi","transaction_no_1":"veniam","transaction_no_2":"labore","transaction_no_3":"fuga","note":"quibusdam","cheque_number":"et"}]}'
    ...
    "payment": [
        {
            ...
            "transaction_no_2": "labore",
            "transaction_no_3": "fuga",
            "note": "quibusdam",
            "cheque_number": "et"
        }
    ]
...
curl -X PUT \
    ...
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}" \
    -d '{"final_total":2576.20318037,"transaction_date":"2020-5-7 15:20:22","tax_rate_id":10,"expense_for":18,"contact_id":9,"additional_notes":"dolor","is_recurring":0,"recur_interval":7,"recur_interval_type":"months","subscription_repeat_on":15,"subscription_no":"dolores","recur_repetitions":13,"payment":[]}'
...
```bash
curl -X GET \
    -G "https://geekbills.in/public/connector/api/expense-refund?location_id=sapiente&payment_status=paid&start_date=2018-06-25&end_date=2018-06-25&expense_for=et&per_page=15" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```bash
curl -X GET \
    -G "https://geekbills.in/public/connector/api/product?order_by=mollitia&order_direction=voluptas&brand_id=natus&category_id=eligendi&sub_category_id=eveniet&location_id=neque&selling_price_group=asperiores&name=dolor&sku=provident&per_page=10" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
let params = {
    "order_by": "mollitia",
    "order_direction": "voluptas",
    "brand_id": "natus",
    "category_id": "eligendi",
    "sub_category_id": "eveniet",
    "location_id": "neque",
    "selling_price_group": "asperiores",
    "name": "dolor",
    "sku": "provident",
    "per_page": "10",
};
...
```bash
curl -X GET \
    -G "https://geekbills.in/public/connector/api/product/1?selling_price_group=accusantium" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
let params = {
    "selling_price_group": "accusantium",
};
Object.keys(params)
    .forEach(key => url.searchParams.append(key, params[key]));
...
```bash
curl -X GET \
    -G "https://geekbills.in/public/connector/api/variation/2?product_id=consequuntur&location_id=voluptas&brand_id=voluptate&category_id=facere&sub_category_id=aut&not_for_selling=quo&name=cum&sku=sint&per_page=10" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```bash
curl -X GET \
    -G "https://geekbills.in/public/connector/api/sell?location_id=qui&contact_id=et&payment_status=paid&start_date=2018-06-25&end_date=2018-06-25&user_id=mollitia&service_staff_id=porro&shipping_status=ordered&only_subscriptions=suscipit&order_by_date=desc&per_page=10" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
let params = {
    ...
    "end_date": "2018-06-25",
    "user_id": "mollitia",
    "service_staff_id": "porro",
    "shipping_status": "ordered",
    "only_subscriptions": "suscipit",
    "order_by_date": "desc",
    "per_page": "10",
};
Object.keys(params)
...
curl -X POST \
    ...
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}" \
    -d '{"sells":[{"location_id":2,"contact_id":6,"transaction_date":"2020-07-22 15:48:29","invoice_no":"ut","status":"final","sub_status":"null","is_quotation":true,"tax_rate_id":5,"discount_amount":10,"discount_type":"fixed","sale_note":"dolorum","staff_note":"nihil","commission_agent":12,"shipping_details":"Express Delivery","shipping_address":"non","shipping_status":"ordered","delivered_to":"'Mr robin'","shipping_charges":10,"packing_charge":10,"exchange_rate":1,"selling_price_group_id":5,"pay_term_number":3,"pay_term_type":"months","is_suspend":false,"is_recurring":0,"recur_interval":19,"recur_interval_type":"months","subscription_repeat_on":15,"subscription_no":"non","recur_repetitions":10,"rp_redeemed":15,"rp_redeemed_amount":13.5,"types_of_service_id":2,"service_custom_field_1":"nihil","service_custom_field_2":"voluptas","service_custom_field_3":"eveniet","service_custom_field_4":"sunt","service_custom_field_5":"dolor","service_custom_field_6":"nulla","round_off_amount":0.61344,"table_id":2,"service_staff_id":15,"change_return":0,"products":[{"product_id":17,"variation_id":58,"quantity":1,"unit_price":437.5,"tax_rate_id":0,"discount_amount":0,"discount_type":"percentage","sub_unit_id":3,"note":"aut"}],"payments":[{"amount":453.13,"method":"cash","account_id":17,"card_number":"fugit","card_holder_name":"accusantium","card_transaction_number":"numquam","card_type":"nesciunt","card_month":"alias","card_year":"sit","card_security":"vel","transaction_no_1":"mollitia","transaction_no_2":"qui","transaction_no_3":"similique","bank_account_number":"quidem","note":"quod","cheque_number":"possimus"}]}]}'
    ...
    "sells": [
        {
            ...
            "service_custom_field_4": "sunt",
            "service_custom_field_5": "dolor",
            "service_custom_field_6": "nulla",
            "round_off_amount": 0.61344,
            "table_id": 2,
            "service_staff_id": 15,
            "change_return": 0,
            "products": [
            ...
            "payments": [
                {
                    ...
                    "account_id": 17,
                    "card_number": "fugit",
                    "card_holder_name": "accusantium",
                    "card_transaction_number": "numquam",
                    "card_type": "nesciunt",
                    "card_month": "alias",
                    "card_year": "sit",
                    "card_security": "vel",
                    "transaction_no_1": "mollitia",
...
curl -X PUT \
    ...
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}" \
    -d '{"contact_id":16,"transaction_date":"2020-5-7 15:20:22","status":"final","sub_status":"null","is_quotation":true,"tax_rate_id":8,"discount_amount":10,"discount_type":"fixed","sale_note":"et","staff_note":"voluptatem","sells":[{"is_suspend":false}],"commission_agent":18,"shipping_details":"Express Delivery","shipping_address":"quis","shipping_status":"ordered","delivered_to":"Mr Robin","shipping_charges":10,"packing_charge":10,"exchange_rate":1,"selling_price_group_id":14,"pay_term_number":15,"pay_term_type":"months","is_recurring":0,"recur_interval":20,"recur_interval_type":"days","subscription_repeat_on":7,"subscription_no":"reprehenderit","recur_repetitions":20,"rp_redeemed":8,"rp_redeemed_amount":13.5,"types_of_service_id":16,"service_custom_field_1":"soluta","service_custom_field_2":"sit","service_custom_field_3":"dolorem","service_custom_field_4":"sed","service_custom_field_5":"in","service_custom_field_6":"iure","round_off_amount":46.74493,"table_id":7,"service_staff_id":18,"change_return":0,"change_return_id":6,"products":[{"sell_line_id":9,"product_id":17,"variation_id":58,"quantity":1,"unit_price":437.5,"tax_rate_id":2,"discount_amount":0,"discount_type":"percentage","sub_unit_id":8,"note":"facilis"}],"payments":[{"payment_id":10,"amount":453.13,"method":"cash","account_id":7,"card_number":"reprehenderit","card_holder_name":"et","card_transaction_number":"quaerat","card_type":"inventore","card_month":"facilis","card_year":"debitis","card_security":"consequatur","transaction_no_1":"laborum","transaction_no_2":"enim","transaction_no_3":"amet","note":"velit","cheque_number":"laudantium","bank_account_number":"eius"}]}'
...
let body = {
    ...
    "subscription_no": "reprehenderit",
    "recur_repetitions": 20,
    "rp_redeemed": 8,
    "rp_redeemed_amount": 13.5,
    "types_of_service_id": 16,
    "service_custom_field_1": "soluta",
    "service_custom_field_2": "sit",
    "service_custom_field_3": "dolorem",
    "service_custom_field_4": "sed",
    "service_custom_field_5": "in",
    "service_custom_field_6": "iure",
    "round_off_amount": 46.74493,
    "table_id": 7,
    "service_staff_id": 18,
    "change_return": 0,
    "change_return_id": 6,
    ...
    "payments": [
        {
            ...
            "method": "cash",
            "account_id": 7,
            "card_number": "reprehenderit",
            "card_holder_name": "et",
            "card_transaction_number": "quaerat",
            "card_type": "inventore",
            "card_month": "facilis",
            "card_year": "debitis",
            "card_security": "consequatur",
            "transaction_no_1": "laborum",
            "transaction_no_2": "enim",
            "transaction_no_3": "amet",
            "note": "velit",
            "cheque_number": "laudantium",
            "bank_account_number": "eius"
        }
    ]
}
...
```bash
curl -X DELETE \
    "https://geekbills.in/public/connector/api/sell/aut" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
curl -X POST \
    ...
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}" \
    -d '{"transaction_id":9,"transaction_date":"2020-5-7 15:20:22","invoice_no":"aliquid","discount_amount":10,"discount_type":"fixed","products":[{"sell_line_id":9,"quantity":1,"unit_price_inc_tax":437.5}]}'
...
curl -X POST \
    ...
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}" \
    -d '{"id":18,"shipping_status":"ordered","delivered_to":"laboriosam"}'
...
```bash
curl -X GET \
    -G "https://geekbills.in/public/connector/api/table?location_id=consequuntur" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```bash
curl -X GET \
    -G "https://geekbills.in/public/connector/api/taxonomy?type=minima" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
curl -X POST \
    ...
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}" \
    -d '{"surname":"quos","first_name":"ipsa","last_name":"molestiae","email":"neque","is_active":"commodi","user_type":"in","crm_contact_id":14,"allow_login":true,"username":"dolores","password":"quisquam","role":19,"access_all_locations":false,"location_permissions":[],"cmmsn_percent":"ut","max_sales_discount_percent":"quibusdam","selected_contacts":false,"selected_contact_ids":[],"dob":"laborum","gender":"hic","marital_status":"nesciunt","blood_group":"eveniet","contact_number":"praesentium","alt_number":"nam","family_number":"asperiores","fb_link":"ut","twitter_link":"ad","social_media_1":"et","social_media_2":"qui","custom_field_1":"dolorum","custom_field_2":"veniam","custom_field_3":"rerum","custom_field_4":"veniam","guardian_name":"aut","id_proof_name":"voluptatum","id_proof_number":"suscipit","permanent_address":"beatae","current_address":"quidem","bank_details":[{"account_holder_name":"quia","account_number":"quis","bank_name":"omnis","bank_code":"ex","branch":"fugit","tax_payer_id":"est"}]}'
...
let body = {
    ...
    "cmmsn_percent": "ut",
    "max_sales_discount_percent": "quibusdam",
    "selected_contacts": false,
    "selected_contact_ids": [],
    "dob": "laborum",
    "gender": "hic",
    "marital_status": "nesciunt",
    "blood_group": "eveniet",
    "contact_number": "praesentium",
    "alt_number": "nam",
    "family_number": "asperiores",
    "fb_link": "ut",
    "twitter_link": "ad",
    "social_media_1": "et",
    "social_media_2": "qui",
    "custom_field_1": "dolorum",
    "custom_field_2": "veniam",
    "custom_field_3": "rerum",
    "custom_field_4": "veniam",
    "guardian_name": "aut",
    "id_proof_name": "voluptatum",
    "id_proof_number": "suscipit",
    "permanent_address": "beatae",
    "current_address": "quidem",
    "bank_details": [
        {
            "account_holder_name": "quia",
            "account_number": "quis",
            "bank_name": "omnis",
            "bank_code": "ex",
            "branch": "fugit",
...
```bash
curl -X GET \
    -G "https://geekbills.in/public/connector/api/user?service_staff=maxime" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
curl -X POST \
    ...
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}" \
    -d '{"current_password":"optio","new_password":"non"}'
...
```bash
curl -X GET \
    -G "https://geekbills.in/public/connector/api/profit-loss-report?location_id=in&start_date=2018-06-25&end_date=2018-06-25&user_id=eos" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
