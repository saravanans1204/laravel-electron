...
[Get Postman Collection](https://geekbills.in/public/docs/collection.json)
...
```bash
curl -X GET \
    -G "https://geekbills.in/public/connector/api/get-attendance/1" \
...
```javascript
const url = new URL(
    "https://geekbills.in/public/connector/api/get-attendance/1"
);
...
```bash
curl -X POST \
    "https://geekbills.in/public/connector/api/clock-in" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}" \
    -d '{"user_id":1,"clock_in_time":"2000-06-13 13:13:00","clock_in_note":"consequuntur","ip_address":"blanditiis","latitude":"porro","longitude":"tempora"}'
...
```bash
curl -X POST \
    "https://geekbills.in/public/connector/api/clock-out" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}" \
    -d '{"user_id":1,"clock_out_time":"2000-06-13 13:13:00","clock_out_note":"vero","latitude":"iure","longitude":"sapiente"}'
...
```bash
curl -X GET \
    -G "https://geekbills.in/public/connector/api/holidays?location_id=molestias&start_date=2020-06-25&end_date=2020-06-25" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "https://geekbills.in/public/connector/api/holidays"
);

let params = {
    "location_id": "molestias",
...
```bash
curl -X GET \
    -G "https://geekbills.in/public/connector/api/brand" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "https://geekbills.in/public/connector/api/brand"
);
...
```bash
curl -X GET \
    -G "https://geekbills.in/public/connector/api/brand/1" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "https://geekbills.in/public/connector/api/brand/1"
);
...
```bash
curl -X GET \
    -G "https://geekbills.in/public/connector/api/business-location" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "https://geekbills.in/public/connector/api/business-location"
);
...
```bash
curl -X GET \
    -G "https://geekbills.in/public/connector/api/business-location/1" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "https://geekbills.in/public/connector/api/business-location/1"
);
...
```bash
curl -X GET \
    -G "https://geekbills.in/public/connector/api/crm/follow-ups?start_date=2020-12-16&end_date=2020-12-16&status=asperiores&follow_up_type=dolores&order_by=start_datetime&direction=desc&per_page=10" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "https://geekbills.in/public/connector/api/crm/follow-ups"
);
...
```bash
curl -X GET \
    -G "https://geekbills.in/public/connector/api/crm/follow-ups/1,2" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "https://geekbills.in/public/connector/api/crm/follow-ups/1,2"
);
...
```bash
curl -X PUT \
    "https://geekbills.in/public/connector/api/crm/follow-ups/20" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}" \
    -d '{"title":"Meeting with client","contact_id":2,"description":"sunt","schedule_type":"qui","user_id":"[2,3,5]","notify_before":5,"notify_type":"minute","status":"open","notify_via":"['sms' => 0 ,'mail' => 1]","followup_additional_info":"['call duration' => '1 hour']","start_datetime":"2021-01-06 13:05:00","end_datetime":"2021-01-06 13:05:00","allow_notification":true}'
...
```bash
curl -X GET \
    -G "https://geekbills.in/public/connector/api/crm/follow-up-resources" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "https://geekbills.in/public/connector/api/crm/follow-up-resources"
);
...
```bash
curl -X GET \
    -G "https://geekbills.in/public/connector/api/crm/leads?assigned_to=1%2C2%2C3&name=nemo&biz_name=et&mobile_num=2&contact_id=voluptas&order_by=voluptas&direction=desc&per_page=10" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "https://geekbills.in/public/connector/api/crm/leads"
);
...
```bash
curl -X POST \
    "https://geekbills.in/public/connector/api/crm/call-logs" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}" \
    -d '{"call_logs":[{"mobile_number":"unde","mobile_name":"necessitatibus","call_type":"call","start_time":"quia","end_time":"dolorum","duration":"vel"}]}'
...
```bash
curl -X GET \
    -G "https://geekbills.in/public/connector/api/cash-register?status=open&user_id=10&start_date=2018-06-25&end_date=2018-06-25&location_id=sunt&per_page=15" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "https://geekbills.in/public/connector/api/cash-register"
);
...
curl -X POST \
    ...
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}" \
    -d '{"location_id":13,"initial_amount":3.922273,"created_at":"2020-5-7 15:20:22","closed_at":"2020-5-7 15:20:22","status":"close","closing_amount":2804644.951914504,"total_card_slips":17,"total_cheques":3,"closing_note":"tenetur","transaction_ids":"1,2,3"}'
...
let body = {
    "location_id": 13,
    "initial_amount": 3.922273,
    "created_at": "2020-5-7 15:20:22",
    "closed_at": "2020-5-7 15:20:22",
    "status": "close",
    "closing_amount": 2804644.951914504,
    "total_card_slips": 17,
    "total_cheques": 3,
    "closing_note": "tenetur",
...
```bash
curl -X GET \
    -G "https://geekbills.in/public/connector/api/cash-register/59" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "https://geekbills.in/public/connector/api/cash-register/59"
);
...
```bash
curl -X GET \
    -G "https://geekbills.in/public/connector/api/contactapi?type=odio&name=debitis&biz_name=quibusdam&mobile_num=1&contact_id=atque&order_by=ut&direction=incidunt&per_page=10" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "https://geekbills.in/public/connector/api/contactapi"
);
...
curl -X POST \
    ...
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}" \
    -d '{"type":"customer","supplier_business_name":"omnis","prefix":"molestias","first_name":"eos","middle_name":"nobis","last_name":"sit","tax_number":"8787fefef","pay_term_number":3,"pay_term_type":"months","mobile":"4578691009","landline":"5487-8454-4145","alternate_number":"841847541222","address_line_1":"dolor","address_line_2":"id","city":"non","state":"exercitationem","country":"aut","zip_code":"voluptatem","customer_group_id":"perspiciatis","contact_id":"omnis","dob":"2000-06-13","custom_field1":"est","custom_field2":"id","custom_field3":"aspernatur","custom_field4":"voluptatem","email":"recusandae","shipping_address":"quia","position":"iure","opening_balance":0,"source_id":11,"life_stage_id":12,"assigned_to":[]}'
...
let body = {
    ...
    "country": "aut",
    "zip_code": "voluptatem",
    "customer_group_id": "perspiciatis",
    "contact_id": "omnis",
    "dob": "2000-06-13",
    "custom_field1": "est",
    "custom_field2": "id",
    "custom_field3": "aspernatur",
...
```bash
curl -X GET \
    -G "https://geekbills.in/public/connector/api/contactapi/1" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "https://geekbills.in/public/connector/api/contactapi/1"
);
...
curl -X PUT \
    ...
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}" \
    -d '{"type":"customer","supplier_business_name":"debitis","prefix":"est","first_name":"sunt","middle_name":"illum","last_name":"dolore","tax_number":"488744dwd","pay_term_number":3,"pay_term_type":"months","mobile":"8795461009","landline":"65484-848-848","alternate_number":"9898795220","address_line_1":"itaque","address_line_2":"dolor","city":"et","state":"et","country":"culpa","zip_code":"et","customer_group_id":"vitae","contact_id":"est","dob":"2000-06-13","custom_field1":"provident","custom_field2":"delectus","custom_field3":"sit","custom_field4":"ea","email":"iste","shipping_address":"accusamus","position":"reiciendis","opening_balance":10.3,"source_id":6,"life_stage_id":14,"assigned_to":[]}'
...
let body = {
    ...
    "contact_id": "est",
    "dob": "2000-06-13",
    "custom_field1": "provident",
    "custom_field2": "delectus",
    "custom_field3": "sit",
    "custom_field4": "ea",
    "email": "iste",
    "shipping_address": "accusamus",
    "position": "reiciendis",
...
```bash
curl -X POST \
    "https://geekbills.in/public/connector/api/contactapi-payment" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}" \
    -d '{"contact_id":17,"amount":453.13,"method":"cash","paid_on":"2020-07-22 15:48:29","account_id":2,"card_number":"voluptas","card_holder_name":"quasi","card_transaction_number":"consequatur","card_type":"ea","card_month":"praesentium","card_year":"illum","card_security":"omnis","transaction_no_1":"veniam","transaction_no_2":"commodi","transaction_no_3":"esse","cheque_number":"facere","bank_account_number":"numquam","note":"est"}'
...
let body = {
    ...
    "account_id": 2,
    "card_number": "voluptas",
    "card_holder_name": "quasi",
    "card_transaction_number": "consequatur",
    "card_type": "ea",
    "card_month": "praesentium",
    "card_year": "illum",
    "card_security": "omnis",
    "transaction_no_1": "veniam",
    "transaction_no_2": "commodi",
    "transaction_no_3": "esse",
    "cheque_number": "facere",
    "bank_account_number": "numquam",
    "note": "est"
}
...
```bash
curl -X GET \
    -G "https://geekbills.in/public/connector/api/expense?location_id=illum&payment_status=paid&start_date=2018-06-25&end_date=2018-06-25&expense_for=inventore&per_page=15" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "https://geekbills.in/public/connector/api/expense"
);
...
curl -X POST \
    ...
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}" \
    -d '{"location_id":1,"final_total":432097983.042,"transaction_date":"2020-5-7 15:20:22","tax_rate_id":12,"expense_for":10,"contact_id":20,"additional_notes":"voluptas","is_refund":0,"is_recurring":0,"recur_interval":1,"recur_interval_type":"months","subscription_repeat_on":15,"subscription_no":"quam","recur_repetitions":7,"payment":[{"amount":453.13,"method":"cash","account_id":5,"card_number":"assumenda","card_holder_name":"quibusdam","card_transaction_number":"voluptas","card_type":"repudiandae","card_month":"ad","card_year":"eligendi","card_security":"nesciunt","transaction_no_1":"hic","transaction_no_2":"molestiae","transaction_no_3":"repellendus","note":"rerum","cheque_number":"soluta"}]}'
    ...
    "payment": [
        {
            ...
            "method": "cash",
            "account_id": 5,
            "card_number": "assumenda",
            "card_holder_name": "quibusdam",
            "card_transaction_number": "voluptas",
            "card_type": "repudiandae",
            "card_month": "ad",
            "card_year": "eligendi",
            "card_security": "nesciunt",
            "transaction_no_1": "hic",
            "transaction_no_2": "molestiae",
            "transaction_no_3": "repellendus",
            "note": "rerum",
            "cheque_number": "soluta"
        }
    ]
}
...
```bash
curl -X GET \
    -G "https://geekbills.in/public/connector/api/expense/59" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "https://geekbills.in/public/connector/api/expense/59"
);
...
```bash
curl -X PUT \
    "https://geekbills.in/public/connector/api/expense/1" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}" \
    -d '{"final_total":1455184.780333615,"transaction_date":"2020-5-7 15:20:22","tax_rate_id":1,"expense_for":16,"contact_id":3,"additional_notes":"ullam","is_recurring":0,"recur_interval":6,"recur_interval_type":"months","subscription_repeat_on":15,"subscription_no":"adipisci","recur_repetitions":2,"payment":[]}'
...
let body = {
    "final_total": 1455184.780333615,
    "transaction_date": "2020-5-7 15:20:22",
    "tax_rate_id": 1,
    "expense_for": 16,
    "contact_id": 3,
    "additional_notes": "ullam",
    "is_recurring": 0,
    "recur_interval": 6,
    "recur_interval_type": "months",
    "subscription_repeat_on": 15,
    "subscription_no": "adipisci",
    "recur_repetitions": 2,
    "payment": []
}
...
```bash
curl -X GET \
    -G "https://geekbills.in/public/connector/api/expense-refund?location_id=vel&payment_status=paid&start_date=2018-06-25&end_date=2018-06-25&expense_for=veniam&per_page=15" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "https://geekbills.in/public/connector/api/expense-refund"
);
...
```bash
curl -X GET \
    -G "https://geekbills.in/public/connector/api/product?order_by=alias&order_direction=ratione&brand_id=error&category_id=aut&sub_category_id=et&location_id=qui&selling_price_group=nihil&name=corporis&sku=blanditiis&per_page=10" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "https://geekbills.in/public/connector/api/product"
);

let params = {
    "order_by": "alias",
    "order_direction": "ratione",
    "brand_id": "error",
    "category_id": "aut",
    "sub_category_id": "et",
    "location_id": "qui",
...
```bash
curl -X GET \
    -G "https://geekbills.in/public/connector/api/product/1?selling_price_group=omnis" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "https://geekbills.in/public/connector/api/product/1"
);
...
```bash
curl -X GET \
    -G "https://geekbills.in/public/connector/api/selling-price-group" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "https://geekbills.in/public/connector/api/selling-price-group"
);
...
```bash
curl -X GET \
    -G "https://geekbills.in/public/connector/api/variation/2?product_id=consequatur&location_id=non&brand_id=eum&category_id=expedita&sub_category_id=rerum&not_for_selling=sed&name=veniam&sku=dolorem&per_page=10" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "https://geekbills.in/public/connector/api/variation/2"
);
...
```bash
curl -X GET \
    -G "https://geekbills.in/public/connector/api/sell?location_id=animi&contact_id=eaque&payment_status=paid&start_date=2018-06-25&end_date=2018-06-25&user_id=nesciunt&service_staff_id=eveniet&shipping_status=ordered&only_subscriptions=consequatur&order_by_date=desc&per_page=10" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "https://geekbills.in/public/connector/api/sell"
);
...
curl -X POST \
    ...
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}" \
    -d '{"sells":[{"location_id":4,"contact_id":6,"transaction_date":"2020-07-22 15:48:29","invoice_no":"ducimus","status":"final","sub_status":"null","is_quotation":true,"tax_rate_id":7,"discount_amount":10,"discount_type":"fixed","sale_note":"adipisci","staff_note":"eius","commission_agent":14,"shipping_details":"Express Delivery","shipping_address":"id","shipping_status":"ordered","delivered_to":"'Mr robin'","shipping_charges":10,"packing_charge":10,"exchange_rate":1,"selling_price_group_id":7,"pay_term_number":3,"pay_term_type":"months","is_suspend":false,"is_recurring":0,"recur_interval":7,"recur_interval_type":"months","subscription_repeat_on":15,"subscription_no":"quo","recur_repetitions":13,"rp_redeemed":15,"rp_redeemed_amount":13.5,"types_of_service_id":20,"service_custom_field_1":"dolore","service_custom_field_2":"voluptas","service_custom_field_3":"velit","service_custom_field_4":"eveniet","service_custom_field_5":"aut","service_custom_field_6":"impedit","round_off_amount":2133704.0238419706,"table_id":11,"service_staff_id":17,"change_return":0,"products":[{"product_id":17,"variation_id":58,"quantity":1,"unit_price":437.5,"tax_rate_id":0,"discount_amount":0,"discount_type":"percentage","sub_unit_id":10,"note":"odio"}],"payments":[{"amount":453.13,"method":"cash","account_id":20,"card_number":"et","card_holder_name":"ratione","card_transaction_number":"voluptas","card_type":"et","card_month":"labore","card_year":"animi","card_security":"fugiat","transaction_no_1":"sit","transaction_no_2":"iure","transaction_no_3":"quia","bank_account_number":"sed","note":"voluptates","cheque_number":"at"}]}]}'
    ...
    "sells": [
        {
            ...
            "service_custom_field_1": "dolore",
            "service_custom_field_2": "voluptas",
            "service_custom_field_3": "velit",
            "service_custom_field_4": "eveniet",
            "service_custom_field_5": "aut",
            "service_custom_field_6": "impedit",
            "round_off_amount": 2133704.0238419706,
            "table_id": 11,
            "service_staff_id": 17,
            "change_return": 0,
            "products": [
            ...
            "payments": [
                {
                    ...
                    "card_month": "labore",
                    "card_year": "animi",
                    "card_security": "fugiat",
                    "transaction_no_1": "sit",
                    "transaction_no_2": "iure",
                    "transaction_no_3": "quia",
                    "bank_account_number": "sed",
                    "note": "voluptates",
                    "cheque_number": "at"
                }
            ]
...
```bash
curl -X GET \
    -G "https://geekbills.in/public/connector/api/sell/55" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "https://geekbills.in/public/connector/api/sell/55"
);
...
```bash
curl -X PUT \
    "https://geekbills.in/public/connector/api/sell/6" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}" \
    -d '{"contact_id":5,"transaction_date":"2020-5-7 15:20:22","status":"final","sub_status":"null","is_quotation":true,"tax_rate_id":6,"discount_amount":10,"discount_type":"fixed","sale_note":"voluptatem","staff_note":"atque","sells":[{"is_suspend":false}],"commission_agent":20,"shipping_details":"Express Delivery","shipping_address":"pariatur","shipping_status":"ordered","delivered_to":"Mr Robin","shipping_charges":10,"packing_charge":10,"exchange_rate":1,"selling_price_group_id":14,"pay_term_number":10,"pay_term_type":"months","is_recurring":0,"recur_interval":19,"recur_interval_type":"days","subscription_repeat_on":7,"subscription_no":"cupiditate","recur_repetitions":12,"rp_redeemed":14,"rp_redeemed_amount":13.5,"types_of_service_id":4,"service_custom_field_1":"doloribus","service_custom_field_2":"nihil","service_custom_field_3":"velit","service_custom_field_4":"et","service_custom_field_5":"qui","service_custom_field_6":"vero","round_off_amount":251920236.916,"table_id":20,"service_staff_id":19,"change_return":0,"change_return_id":4,"products":[{"sell_line_id":11,"product_id":17,"variation_id":58,"quantity":1,"unit_price":437.5,"tax_rate_id":6,"discount_amount":0,"discount_type":"percentage","sub_unit_id":17,"note":"nulla"}],"payments":[{"payment_id":12,"amount":453.13,"method":"cash","account_id":12,"card_number":"quia","card_holder_name":"totam","card_transaction_number":"eum","card_type":"voluptatem","card_month":"ut","card_year":"nam","card_security":"est","transaction_no_1":"ut","transaction_no_2":"adipisci","transaction_no_3":"id","note":"occaecati","cheque_number":"minima","bank_account_number":"optio"}]}'
...
let body = {
    ...
    "subscription_no": "cupiditate",
    "recur_repetitions": 12,
    "rp_redeemed": 14,
    "rp_redeemed_amount": 13.5,
    "types_of_service_id": 4,
    "service_custom_field_1": "doloribus",
    "service_custom_field_2": "nihil",
    "service_custom_field_3": "velit",
    "service_custom_field_4": "et",
    "service_custom_field_5": "qui",
    "service_custom_field_6": "vero",
    "round_off_amount": 251920236.916,
    "table_id": 20,
    "service_staff_id": 19,
    "change_return": 0,
    "change_return_id": 4,
    ...
    "payments": [
        {
            ...
            "card_transaction_number": "eum",
            "card_type": "voluptatem",
            "card_month": "ut",
            "card_year": "nam",
            "card_security": "est",
            "transaction_no_1": "ut",
            "transaction_no_2": "adipisci",
            "transaction_no_3": "id",
            "note": "occaecati",
            "cheque_number": "minima",
            "bank_account_number": "optio"
        }
    ]
}
...
```bash
curl -X DELETE \
    "https://geekbills.in/public/connector/api/sell/sit" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```bash
curl -X POST \
    "https://geekbills.in/public/connector/api/sell-return" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}" \
    -d '{"transaction_id":4,"transaction_date":"2020-5-7 15:20:22","invoice_no":"id","discount_amount":10,"discount_type":"fixed","products":[{"sell_line_id":7,"quantity":1,"unit_price_inc_tax":437.5}]}'
...
```bash
curl -X GET \
    -G "https://geekbills.in/public/connector/api/list-sell-return" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "https://geekbills.in/public/connector/api/list-sell-return"
);
...
```bash
curl -X POST \
    "https://geekbills.in/public/connector/api/update-shipping-status" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}" \
    -d '{"id":12,"shipping_status":"ordered","delivered_to":"praesentium"}'
...
```bash
curl -X GET \
    -G "https://geekbills.in/public/connector/api/active-subscription" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "https://geekbills.in/public/connector/api/active-subscription"
);
...
```bash
curl -X GET \
    -G "https://geekbills.in/public/connector/api/packages" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "https://geekbills.in/public/connector/api/packages"
);
...
```bash
curl -X GET \
    -G "https://geekbills.in/public/connector/api/table?location_id=dolores" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "https://geekbills.in/public/connector/api/table"
);
...
```bash
curl -X GET \
    -G "https://geekbills.in/public/connector/api/table/5" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "https://geekbills.in/public/connector/api/table/5"
);
...
```bash
curl -X GET \
    -G "https://geekbills.in/public/connector/api/tax" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "https://geekbills.in/public/connector/api/tax"
);
...
```bash
curl -X GET \
    -G "https://geekbills.in/public/connector/api/tax/1" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "https://geekbills.in/public/connector/api/tax/1"
);
...
```bash
curl -X GET \
    -G "https://geekbills.in/public/connector/api/taxonomy?type=sint" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "https://geekbills.in/public/connector/api/taxonomy"
);
...
```bash
curl -X GET \
    -G "https://geekbills.in/public/connector/api/taxonomy/1" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "https://geekbills.in/public/connector/api/taxonomy/1"
);
...
```bash
curl -X GET \
    -G "https://geekbills.in/public/connector/api/types-of-service" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "https://geekbills.in/public/connector/api/types-of-service"
);
...
```bash
curl -X GET \
    -G "https://geekbills.in/public/connector/api/types-of-service/1" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "https://geekbills.in/public/connector/api/types-of-service/1"
);
...
```bash
curl -X GET \
    -G "https://geekbills.in/public/connector/api/unit" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "https://geekbills.in/public/connector/api/unit"
);
...
```bash
curl -X GET \
    -G "https://geekbills.in/public/connector/api/unit/1" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "https://geekbills.in/public/connector/api/unit/1"
);
...
```bash
curl -X GET \
    -G "https://geekbills.in/public/connector/api/user/loggedin" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "https://geekbills.in/public/connector/api/user/loggedin"
);
...
```bash
curl -X POST \
    "https://geekbills.in/public/connector/api/user-registration" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}" \
    -d '{"surname":"ut","first_name":"quis","last_name":"adipisci","email":"temporibus","is_active":"ab","user_type":"minima","crm_contact_id":9,"allow_login":true,"username":"quod","password":"exercitationem","role":11,"access_all_locations":true,"location_permissions":[],"cmmsn_percent":"cupiditate","max_sales_discount_percent":"modi","selected_contacts":true,"selected_contact_ids":[],"dob":"aut","gender":"molestiae","marital_status":"voluptas","blood_group":"eum","contact_number":"ullam","alt_number":"laboriosam","family_number":"laudantium","fb_link":"ex","twitter_link":"nemo","social_media_1":"modi","social_media_2":"ut","custom_field_1":"illum","custom_field_2":"adipisci","custom_field_3":"eius","custom_field_4":"ut","guardian_name":"laudantium","id_proof_name":"dolorum","id_proof_number":"odio","permanent_address":"voluptatem","current_address":"qui","bank_details":[{"account_holder_name":"soluta","account_number":"perferendis","bank_name":"adipisci","bank_code":"vel","branch":"deserunt","tax_payer_id":"blanditiis"}]}'
...
let body = {
    ...
    "cmmsn_percent": "cupiditate",
    "max_sales_discount_percent": "modi",
    "selected_contacts": true,
    "selected_contact_ids": [],
    "dob": "aut",
    "gender": "molestiae",
    "marital_status": "voluptas",
    "blood_group": "eum",
    "contact_number": "ullam",
    "alt_number": "laboriosam",
    "family_number": "laudantium",
    "fb_link": "ex",
    "twitter_link": "nemo",
    "social_media_1": "modi",
    "social_media_2": "ut",
    "custom_field_1": "illum",
    "custom_field_2": "adipisci",
    "custom_field_3": "eius",
    "custom_field_4": "ut",
    "guardian_name": "laudantium",
    "id_proof_name": "dolorum",
    "id_proof_number": "odio",
    "permanent_address": "voluptatem",
    "current_address": "qui",
    "bank_details": [
        {
            "account_holder_name": "soluta",
            "account_number": "perferendis",
            "bank_name": "adipisci",
            "bank_code": "vel",
            "branch": "deserunt",
            "tax_payer_id": "blanditiis"
        }
    ]
}
...
```bash
curl -X GET \
    -G "https://geekbills.in/public/connector/api/user?service_staff=sit" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "https://geekbills.in/public/connector/api/user"
);
...
```bash
curl -X GET \
    -G "https://geekbills.in/public/connector/api/user/1" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "https://geekbills.in/public/connector/api/user/1"
);
...
```bash
curl -X POST \
    "https://geekbills.in/public/connector/api/update-password" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}" \
    -d '{"current_password":"ea","new_password":"mollitia"}'
...
```bash
curl -X POST \
    "https://geekbills.in/public/connector/api/forget-password" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}" \
    -d '{"email":"eum"}'
...
```bash
curl -X GET \
    -G "https://geekbills.in/public/connector/api/payment-accounts" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "https://geekbills.in/public/connector/api/payment-accounts"
);
...
```bash
curl -X GET \
    -G "https://geekbills.in/public/connector/api/payment-methods" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "https://geekbills.in/public/connector/api/payment-methods"
);
...
```bash
curl -X GET \
    -G "https://geekbills.in/public/connector/api/business-details" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "https://geekbills.in/public/connector/api/business-details"
);
...
```bash
curl -X GET \
    -G "https://geekbills.in/public/connector/api/profit-loss-report?location_id=nostrum&start_date=2018-06-25&end_date=2018-06-25&user_id=tenetur" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "https://geekbills.in/public/connector/api/profit-loss-report"
);
...
```bash
curl -X GET \
    -G "https://geekbills.in/public/connector/api/product-stock-report" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "https://geekbills.in/public/connector/api/product-stock-report"
);
...
```bash
curl -X GET \
    -G "https://geekbills.in/public/connector/api/notifications" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "https://geekbills.in/public/connector/api/notifications"
);
